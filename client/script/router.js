define( 
    [ "jquery" , "underscore" , "backbone" , "m/object_user" , "v/login" , "v/stream" , "v/search" , "jqm" ],
    function( $ , _ , Backbone , ObjectUserModel , LoginView , StreamView , SearchView ) {
        "use strict";
        ...
        var Router = Backbone.Router.extend({
            ...
            showLogin: function(){
                ...
                this.changePage( new LoginView( this ) );
            },
            ...
            showStream: function(){
                ...
                this.changePage( new StreamView( this ) );
            },
            ...
            showSearch: function(){
                ...
                this.changePage( new SearchView( this ) );
            },
